        ...
        <div className="flex items-start justify-between flex-wrap gap-3">
          <div>
            ...
            <div className="flex items-center gap-3 mt-2 flex-wrap">
              <span className="text-sm text-slate-400 capitalize">{report.depth}</span>
              <ConfidenceBadge value={report.overall_confidence} />
              <span className="text-sm text-slate-400">{report.claims.length} claims / {report.sources.length} sources</span>
            </div>
          </div>
            ...
            {report.sources.map((source, i) => (
              <div key={i} className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-sm text-blue-400 hover:text-blue-300 truncate flex-1 transition-colors"
                >
